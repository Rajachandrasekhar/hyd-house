...
!(function (e, t) {
  ...
  var Q = "collapse",
    ...
    ee = (function (e) {
      function s(t, i) {
        ...
        for (
          var s = q.find('[data-bs-toggle="collapse"]'), r = 0, o = s.length;
          r < o;
          r++
        ) {
          var a = s[r],
  ...
  function Ge(e, t) {
    ...
    var i = t,
      ...
      _ = je(v),
      x = qe({ reference: _, element: y, strategy: "absolute", placement: s }),
  ...
  var st = nt(),
    rt = nt({ defaultModifiers: [Ae, Ke, Oe, he] }),
    ot = nt({ defaultModifiers: [Ae, Ke, Oe, he, Qe, Ve, Ze, Ce, Je] }),
    at = Object.freeze({
      __proto__: null,
      popperGenerator: nt,
      detectOverflow: Ge,
  ...
  b(function () {
    ...
    if (e) {
      var t = e.fn[It];
      (e.fn[It] = Ht.jQueryInterface),
        (e.fn[It].Constructor = Ht),
      ...
      return (
        (o = function (t) {
          ...
          T.id && k.attr("id", T.id),
            ...
            P.find(".xdsoft_year span").after(N),
              ...
              .on("xchange.xdsoft", function (o) {
                clearTimeout(r),
                  (r = setTimeout(function () {
                    ...
                    if (
                      (!1 !== T.maxTime &&
                        ((L = M.strtotime(T.maxTime)),
                        (I = 60 * L.getHours() + L.getMinutes())),
                      !1 !== T.minDateTime &&
                        ((L = M.strToDateTime(T.minDateTime)),
                        i.formatDate(M.currentTime, T.formatDate) ===
                          i.formatDate(L, T.formatDate)))
                    ) {
                    ...
                    if (
                      (!1 !== T.maxDateTime &&
                        ((L = M.strToDateTime(T.maxDateTime)),
                        i.formatDate(M.currentTime, T.formatDate) ===
                          i.formatDate(L, T.formatDate) &&
  ...
  (function (e, t) {
    ...
    function o(e, t) {
      ...
      return (i = "scroll" + n) && s(e)
        ? Math.max(L[i], I[i]) -
            (P["inner" + n] || L["client" + n] || I["client" + n])
        : e[i] - e["offset" + n];
    }
    function a(e) {
    ...
    function b(e, t, i, n, r, o, a) {
      ...
      return (
        ...
        (!m && f) ||
          (b += (n === ge ? ie : ne) + ":" + (o + parseFloat(u)) + "px;"),
        a &&
          (b +=
    ...
    function S(e) {
      for (var t = Te("refreshInit"), i = _e.length, n = i; n--; )
        _e[n].scroll.rec = _e[n].scroll();
    ...
    function T(e, t, i) {
      if (e.parentNode !== t) {
        for (var n, s = Ce.length, r = t.style, o = e.style; s--; )
          r[(n = Ce[s])] = i[n];
    ...
    function C(e, t, i, n, s, r, o, c, p, f, m, g) {
      if (
        ...
        (x && (x.left || x.top)) ||
          ...
          o && we(o, b, n, m, i - b < 20 || (o._isStart && 20 < b)),
          (i -= i - b);
      }
      if (r) {
        var E = e + i,
        ...
        (g = "scroll" + n.d2),
          we(
            ...
            m,
            (T && 20 < E) ||
              (!T && (m ? Math.max(I[g], L[g]) : r.parentNode[g]) <= E + 1)
          ),
          m &&
            ((p = h(o)),
            ...
            ((r.modifiers = {})[o] = function (e) {
              return (
                n() !== i
                  ...
                  : l && (e = a + l * c.ratio + d * c.ratio * c.ratio),
                (i = Math.round(e))
              );
            }),
    ...
    var D,
      ...
      Me = function () {
        ...
        for (
          n &&
          (U && !$ && 200 < i - U && ((U = 0), Te("scrollEnd")),
          (B = X),
          (X = i));
          t < e;
          t++
        )
          _e[t] && _e[t].update(0, n);
        N = 0;
      },
      Ce = [
        ee,
      ...
      Oe = function (e) {
        for (var t, i, n = e.t.style, s = e.length, r = 0; r < s; r += 2)
          (i = e[r + 1]),
            ...
            i
              ? (n[t] = i)
              : n[t] && n.removeProperty(t.replace(De, "-$1").toLowerCase());
      },
      Pe = { left: 0, top: 0 },
      Ae = /(?:webkit|moz|length)/i;
    me.op = ge;
    var Le =
      ((Ie.prototype.init = function (e, i) {
        if (((this.progress = 0), this.vars && this.kill(1), J)) {
          var n,
            ...
            Fe,
            Be,
            Ye = (e = p(a(e) || d(e) || e.nodeType ? { trigger: e } : e, ye))
              .horizontal
              ? me
              : ge,
            Re = e.onUpdate,
          ...
          (Ze *= 45),
            ...
            (ht.tweenTo = n = at.tweenScroll[Ye.p]),
            i &&
              ((i.vars.lazy = !1),
              i._initted ||
            ...
            nt &&
              ...
              (w = l(nt.snapTo)
                ...
                : D.utils.snap(nt.snapTo)),
              (He = c((He = nt.duration || { min: 0.1, max: 2 }))
                ? F(He.min, He.max)
                : F(He, He)),
              (Fe = D.delayedCall(nt.delay || Ne / 2 || 0.1, function () {
                if (!U || (U === We && !$)) {
                  ...
                  if (l <= W && z <= l) {
                    ...
                    n(
                      d,
                      {
                        duration: He(
                          Q(
                            (0.185 * Math.max(Q(r - e), Q(o - e))) / t / 0.05 ||
                              0
                          )
                        ),
                        ease: nt.ease || "power3",
                        ...
                        onComplete: function () {
                          (Le = ze =
                            i && !rt ? i.totalProgress() : ht.progress),
                            tt && tt(ht);
                        },
                      },
                      z + e * K,
            ...
            qe && (xe[qe] = ht),
            (Ue = ht.trigger = H(Ue || Je)[0]),
            (Je = !0 === Je ? Ue : H(Je)[0]),
            a($e) && ($e = { targets: Ue, className: $e }),
            Je &&
              (!1 === Qe ||
                Qe === ue ||
                (Qe = "flex" !== u(Je.parentNode).display && ce),
              (ht.pin = Je),
              !1 !== e.force3D && D.set(Je, { force3D: !0 }),
              (m = D.core.getCache(Je)).spacer
                ? (Z = m.pinState)
                : ((m.spacer = ie = A.createElement("div")),
                  ie.setAttribute(
                    "class",
              ...
              (Te = De[Qe + Ye.os2]),
              (be = D.getProperty(Je)),
              (we = D.quickSetter(Je, Ye.a, fe)),
              T(Je, ie, De),
              (te = M(Je))),
            ut &&
              ((X = c(ut) ? p(ut, ve) : ve),
              (Y = b("scroller-start", qe, ot, Ye, X, 0)),
              (q = b("scroller-end", qe, ot, Ye, X, 0, Y)),
              (ne = Y["offset" + Ye.op.d2]),
              (j = b("start", qe, ot, Ye, X, ne)),
              (N = b("end", qe, ot, Ye, X, ne)),
              lt ||
                ((function (e) {
                  e.style.position =
                ...
                D.set([Y, q], { force3D: !0 }),
                (Ce = D.quickSetter(Y, Ye.a, fe)),
                (ke = D.quickSetter(q, Ye.a, fe)))),
            ...
            (ht.refresh = function (t) {
              if (!R && Be)
                if (Je && t && U) g(Ie, "scrollEnd", ft);
                  ...
                  (R = 1),
                    je && je.kill(),
                    Ke && i && i.progress(0).invalidate().progress(ht.progress),
                    S || ht.revert();
                  var r,
                    d,
                    c,
                    ...
                    v,
                    b,
                    w = (lt ? P["inner" + Ye.d2] : ot["client" + Ye.d2]) || 0,
                    _ = lt ? Pe : h(ot),
                    x = o(ot, Ye),
                    E = 0,
                    k = 0,
                  ...
                  if (H) for (v = H; v--; ) _e[v].pin === Je && _e[v].revert();
                  if (
                    ((z =
                      C(L, Ue, w, Ye, ht.scroll(), j, Y, ht, _, pt, lt, x) ||
                      (Je ? -0.001 : 0)),
                    l(O) && (O = O(ht)),
                    a(O) &&
                      !O.indexOf("+=") &&
                    ...
                    for (v = H; v--; )
                      (b = _e[v]).pin === Je &&
                        b.start - b._pinPush < z &&
                        (k += b.end - b.start);
                    if (
                      ((z += k),
                      (W += k),
                      (ht._pinPush = k),
                      j && k && (((r = {})[Ye.a] = "+=" + k), D.set([j, N], r)),
                      (r = u(Je)),
                      (p = Ye === ge),
                      (c = ht.scroll()),
                      (Se = parseFloat(be(Ye.a)) + k),
                      T(Je, ie, r),
                      (te = M(Je)),
                      (d = h(Je, !0)),
                      Qe &&
                        ((ie.style[Qe + Ye.os2] = K + k + fe),
                        (Me = Qe === ce ? f(Je, Ye) + K + k : 0) &&
                          (ie.style[Ye.d] = Me + fe),
                        lt && ht.scroll(n)),
                      lt &&
                        (((m = {
                          ...
                          Math.ceil(d.width) + fe),
                        (m[re] = m["max" + he] = Math.ceil(d.height) + fe),
                        (m[ue] =
                          m[ue + le] =
                          m[ue + oe] =
                          m[ue + de] =
                      ...
                      i
                        ? (i.progress(1, !0),
                          (Ee = be(Ye.a) - Se + K + k),
                          K !== Ee && ee.splice(ee.length - 2, 2),
                          i.progress(0, !0))
                        : (Ee = K),
                      H)
                    )
                      for (v = 0; v < H; v++)
                        _e[v].pin === Je && _e[v].revert(!1);
                  } else if (Ue && ht.scroll())
                    for (d = Ue.parentNode; d && d !== I; )
                      d._pinOffset &&
                        ((z -= d._pinOffset), (W -= d._pinOffset)),
                        (d = d.parentNode);
                  (ht.start = z),
                    (ht.end = W),
                    ...
                    s !== ht.progress &&
                      ...
                      (ht.progress = s),
                      ht.update()),
                    Je && Qe && (ie._pinOffset = Math.round(ht.progress * Ee)),
                    Ve && Ve(ht);
                }
            }),
            ...
            (ht.update = function (e, t) {
              ...
              if (
                (t &&
                  ((L = O),
                  (O = c),
                  nt && ((ze = Le), (Le = i && !rt ? i.totalProgress() : f))),
                Ze &&
                  !f &&
                  Je &&
                  !R &&
                ...
                if (
                  ((l =
                    (d = (s = ht.isActive = !!f && f < 1) != (!!m && m < 1)) ||
                    !!f != !!m),
                  (ht.direction = m < f ? 1 : -1),
                  (ht.progress = f),
                  rt ||
                    (!je || R || G
                      ? i && i.totalProgress(f, !!R)
                    ...
                    if (l) {
                      if (((a = !e && c + 1 >= o(ot, Ye)), st)) {
                        if (!R && (s || a)) {
                          var g = h(Je, !0),
                            v = c - z;
                          (Je.style.top = g.top + (Ye === ge ? v : 0) + fe),
                            (Je.style.left = g.left + (Ye === ge ? 0 : v) + fe);
                        }
                        !(function (e, t) {
                          if (e.parentNode !== t) {
                            var i,
                ...
                !nt || n.tween || R || G || ((We = U), Fe.restart(!0)),
                  $e &&
                    d &&
                    (!it || s) &&
                    H($e.targets).forEach(function (e) {
                  ...
                  l && !R
                    ? ((r = f && !m ? 0 : 1 === f ? 1 : 1 === m ? 2 : 3),
                      1 === f && it
                        ...
                        : rt &&
                          ((a =
                            (!d && "none" !== ct[r + 1] && ct[r + 1]) || ct[r]),
                          i &&
                            ("complete" === a || "reset" === a || a in i) &&
                            ("complete" === a
            ...
            (ht.enable = function () {
              Be ||
                ...
                g(ot, "resize", x),
                g(ot, "scroll", _),
                mt && g(Ie, "refreshInit", mt),
                i &&
                  (i.add
                    ? D.delayedCall(0.01, ht.refresh) &&
                      (K = 0.01) &&
                      (z = W = 0)
                    : ht.refresh()));
            }),
      ...
      (Ie.register = function (e) {
        if (
          ...
          D &&
            ((H = D.utils.toArray),
            (F = D.utils.clamp),
            D.core.globals("ScrollTrigger", Ie),
            I))
        ) {
          (j =
          ...
          (r.borderTop = "1px solid #000"),
            ...
            g(A, "touchcancel", t),
            g(I, "touchstart", t),
            m(g, A, "pointerdown,touchstart,mousedown", function () {
              return ($ = 1);
            }),
            m(g, A, "pointerup,touchend,mouseup", function () {
              return ($ = 0);
            }),
            (q = D.utils.checkPrefix("transform")),
            ke.push(q),
            (O = V()),
            (W = D.delayedCall(0.2, S).pause()),
            g(A, "visibilitychange", function () {
              return A.hidden || S();
            }),
            g(A, "DOMContentLoaded", S),
            g(P, "load", function () {
              return U || S();
            }),
            g(P, "resize", x);
        ...
        const c = () => {
          ...
          u = () => {
            ...
            d.history.replaceState
              ? (d.history.replaceState(null, null, `#${i}` || ""),
                s("hashSet"))
